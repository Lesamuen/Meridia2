...
def getTime() -> str:
    '''
    Returns the current time in extended ISO8601 format
    '''
...
async def playAudio(vc: VoiceChannel, file: str):
    '''
    Has the bot join a specified voice channel, and play an audio clip from ./audio/<file>.ogg
    ...
    if voice_client is None:
        log("ERROR >> Audio commands have intersected!")
        return
    ...
    if not voice_client.is_playing():
        try:
            ...
            log("ERROR >> Audio commands have collided!")
    else:
